    ...
    <nav className="absolute top-0 left-0 w-full z-50 bg-transparent backdrop-blur-md text-white py-4">
      <div className="mx-auto flex justify-between items-center px-6 md:px-10">
        ...
        <ul className="hidden md:flex space-x-6 font-medium">
          ...
          <li><Link to="/portofolio" className="hover:text-orange-500">Portofolio</Link></li>
      ...
      {isOpen && (
        <div className="md:hidden bg-white/80 backdrop-blur-lg text-black absolute top-full left-0 w-full shadow-lg">
